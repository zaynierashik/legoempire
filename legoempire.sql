...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2023 at 01:00 PM
...
INSERT INTO `lego_data` (`legoId`, `title`, `price`, `stock`, `category`, `age`, `pieces`, `points`, `itemNumber`, `specifications`, `specifications-point`, `title-one`, `title-two`, `title-three`, `main-image`, `secondary-image`, `image-one`, `image-two`, `image-three`) VALUES
