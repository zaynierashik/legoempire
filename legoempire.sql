...
INSERT INTO `order_data` (`orderId`, `userId`, `legoId`, `title`, `price`, `quantity`, `transactionId`, `paymentId`, `status`, `delieverStatus`) VALUES
(1, 1, 1, 'LEGO® Minifigures Marvel Series 2', 700, 1, 'YY6mLxvWWsUbrJaegrUCqK', '', 'Paid', 'Pending'),
(2, 1, 4, 'Endgame Final Battle', 555, 1, 'ti9qg6LMyerjsUuM5pCWsK', '', 'Paid', 'Pending');
